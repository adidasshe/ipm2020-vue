<template>
  <div class="app-container">
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <span>数据列表</span>
      <el-button size="mini" class="btn-add" @click="handleAdd()" style="margin-left: 20px" type="primary">添加</el-button>
      <el-button size="mini" class="btn-add" type="primary" @click="handleShowCategory()">资源分类</el-button>
    </el-card>
